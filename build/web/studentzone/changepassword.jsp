            ...
            <div class="row ">
                <div class="col-sm-12 d-flex align-items-center" style="background-image:url('../images/change.jpg');background-size:cover;min-height:600px">
                    ...
                    <div id="password-update"  >
                       ...
                       <form method="post" action="studentcontroller.jsp" class="form-group d-flex flex-column align-items-center " id="frmchangepassword"onsubmit="event.preventDefault();validate();" style="min-height:350px;">                       
